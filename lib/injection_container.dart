...
import 'package:firesbase_test/features/product_list/data/repository/product_detalls_imply.dart';
...
// credusecase registration
  ...
  //repository
   ...
   sl.registerLazySingleton<ProductRepository>(() => ProductRepoImply() );
